...
static PyObject * THPVariable_bitwise_or(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    if (r.isNone(2)) {
      return wrap(dispatch_bitwise_or(r.tensor(0), r.tensor(1)));
    } else {
      return wrap(dispatch_bitwise_or(r.tensor(0), r.tensor(1), r.tensor(2)));
    }
  } else if (r.idx == 1) {
    if (r.isNone(2)) {
      return wrap(dispatch_bitwise_or(r.tensor(0), r.scalar(1)));
    } else {
      return wrap(dispatch_bitwise_or(r.tensor(0), r.scalar(1), r.tensor(2)));
    }
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
...
static PyObject * THPVariable_cudnn_convolution(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    return wrap(dispatch_cudnn_convolution(r.tensor(0), r.tensor(1), r.intlist(2), r.intlist(3), r.intlist(4), r.toInt64(5), r.toBool(6), r.toBool(7)));
  } else if (r.idx == 1) {
...
static PyObject * THPVariable_cudnn_convolution_transpose(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    return wrap(dispatch_cudnn_convolution_transpose(r.tensor(0), r.tensor(1), r.intlist(2), r.intlist(3), r.intlist(4), r.intlist(5), r.toInt64(6), r.toBool(7), r.toBool(8)));
  } else if (r.idx == 1) {
...
static PyObject * THPVariable_isinf(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    return wrap(dispatch_isinf(r.tensor(0)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
