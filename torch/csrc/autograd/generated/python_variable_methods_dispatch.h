...
inline Tensor dispatch_bitwise_or(Tensor & self, const Tensor & other) {

  pybind11::gil_scoped_release no_gil;
  return self.bitwise_or(other);
}
inline Tensor dispatch_bitwise_or(Tensor & self, Scalar other) {

  pybind11::gil_scoped_release no_gil;
  return self.bitwise_or(other);
}
inline Tensor dispatch_bitwise_or_(Tensor & self, const Tensor & other) {

  pybind11::gil_scoped_release no_gil;
  return self.bitwise_or_(other);
}
inline Tensor dispatch_bitwise_or_(Tensor & self, Scalar other) {
