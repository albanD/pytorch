...
inline Tensor dispatch_bitwise_or(const Tensor & self, const Tensor & other, Tensor out) {

  pybind11::gil_scoped_release no_gil;
  return at::bitwise_or_out(out, self, other);
}
inline Tensor dispatch_bitwise_or(const Tensor & self, const Tensor & other) {

  pybind11::gil_scoped_release no_gil;
  return self.bitwise_or(other);
}
inline Tensor dispatch_bitwise_or(const Tensor & self, Scalar other, Tensor out) {

  pybind11::gil_scoped_release no_gil;
  return at::bitwise_or_out(out, self, other);
}
inline Tensor dispatch_bitwise_or(const Tensor & self, Scalar other) {
...
inline Tensor dispatch_cudnn_convolution(const Tensor & self, const Tensor & weight, IntArrayRef padding, IntArrayRef stride, IntArrayRef dilation, int64_t groups, bool benchmark, bool deterministic) {
...
inline Tensor dispatch_cudnn_convolution_transpose(const Tensor & self, const Tensor & weight, IntArrayRef padding, IntArrayRef output_padding, IntArrayRef stride, IntArrayRef dilation, int64_t groups, bool benchmark, bool deterministic) {
...
inline Tensor dispatch_isinf(const Tensor & self) {
